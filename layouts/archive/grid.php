...
if ( $post_count % 5 == 0 ) {
	...
	echo '<div class="edm-archive-classic-post-wrapper">';
} else {
	if ( $post_count == 1 || $post_count == 6 ) {
		echo '<div class="edm-archive-grid-post-wrapper edm-clearfix">';
	}
	...
	<div class="edm-archive-post-content-wrapper">
		...
		<div class="entry-content">
			...
			<span class="edm-archive-more">
				<a href="<?php the_permalink(); ?>" class="edm-button">
					<?php echo esc_html( $education_master_archive_read_more_text ); ?></a></span>
		</div><!-- .entry-content -->
